...
public class Container<E> implements Renderable, Updatable {
    ...
    /**
     * Add a new {@link Updatable} or {@link Renderable} to the list of updating and rendering entities.
     * 
     * @param e
     *            - The {@link Updatable} or {@link Renderable} to be added to the list
     */
    public void add(E e) {
	if (!all.contains(e)) {
	    toBeAdded.add(e);
    ...
    /**
     * Removes an {@link Updatable} or {@link Renderable} from the list of updating and rendering
     * entities.
     * 
     * @param e
     *            - The {@link Updatable} or {@link Renderable} to be removed from the list
     */
